            ...
            <table class="table table-condensed table-align" id="myTable">
                ...
                <c:forEach items="${takmicenja}" var="takmicenje"> 
                    <tr>
                        ...
                        <td>
                            <a href="/njt/prijava/details/${takmicenje.takmicenjeId}/add" class="btn btn-dark"><span class='fa fa-fw fa-plus'></span></a>
                            <a href="/njt/prijava/details/${takmicenje.takmicenjeId}" class="btn btn-dark"><span class='fa fa-fw fa-question'></span></a>
                        </td>
