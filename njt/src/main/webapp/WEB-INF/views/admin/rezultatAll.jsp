                ...
                <tbody>
                    ...
                    <c:forEach items="${takmicenja}" var="takmicenje"> 
                        <tr>
                            ...
                            <td>
                                <a href="/njt/admin/viewR/${takmicenje.takmicenjeId}" class="btn btn-dark"><span class='fa fa-fw fa-question'></span></a>
                                <a href="/njt/admin/editR/${takmicenje.takmicenjeId}" class="btn btn-dark"><span class='fa fa-fw fa-pencil'></span></a>
                            </td>
