            ...
            <table class="table table-condensed table-align" id="myTable">
                <thead>
                    <tr>
                        ...
                        <th>Zemlja</th>
                        <th>Pol</th>
                        <th class='text-right'><a href="/njt/admin/addS" class="btn btn-dark"><span class='fa fa-fw fa-plus'></span></a></th>
                ...
                <tbody>
                    <c:forEach items="${plivaci}" var="plivac"> 
                        <tr>
                            ...
                            <td>
                            <td>
                                <a href="/njt/admin/getS/${plivac.plivacId}" class="btn btn-dark"><span class='fa fa-fw fa-question'></span></a>
                                <a href="/njt/admin/editS/${plivac.plivacId}" class="btn btn-dark"><span class='fa fa-fw fa-pencil'></span></a>
                                <a href="/njt/admin/deleteS/${plivac.plivacId}" class="btn btn-dark"><span class='fa fa-fw fa-trash'></span></a>
                            </td>
