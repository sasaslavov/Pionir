...
<!--<link rel="stylesheet" type="text/css" href="../../resources/styles/index2.css">-->
      ...
      if (x == "" || x == null) {
            ...
            <div class="container-fluid">
                        <form:form action="/njt/admin/addS" name="myForm" method="post" onsubmit="return validateForm()" modelAttribute="plivac">
                            <div class="form-group">
                                <form:label path="plivacId">ID</form:label>
                                <form:input path="plivacId" class="form-control" id="plivacId" disabled="true" />
                            </div>
                            <div class="form-group">
