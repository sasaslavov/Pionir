    ...
    <body>
        ...
        <div class="col-6 col-md-10">
            ...
            <div class="container-fluid">
                <form:form action="/njt/admin/addT" onsubmit="return validateForm()" method="post" modelAttribute="takmicenje">
                    ...
                    <div class="form-group">
                        <form:label path="datumOdrzavanja">Datum Odražavanja</form:label>
