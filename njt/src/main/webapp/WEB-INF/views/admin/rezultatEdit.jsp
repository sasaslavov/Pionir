...
<html>
    ...
    <body>
        ...
        <div class="col-6 col-md-10">
            <form:form method="post" action="/njt/admin/editR/${takmicenje.takmicenjeId}" modelAttribute="rezultatForma">
                    ...
                    <tbody>
                        <c:forEach items="${rezultatForma.rezultati}" var="rezultat" varStatus="status"> 
                            <tr>
                                ...
                                <td><input name="rezultati[${status.index}].plivac.prezimePivaca" value="${rezultat.plivac.prezimePlivaca}" disabled/> </td>
